                ...
                <?php
                 if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){cs_shortcode_element_size();}?>
                    ...
                    <ul class="form-elements">
                            ...
                            <div class="input-sec">
                              <div class="select-style">
                                <select name="cs_blog_view[]" class="dropdown">
                                  <option value="blog-small" <?php if($cs_blog_view == 'blog-small'){echo 'selected="selected"';}?>><?php _e('Blog Small','dir');?></option>
                                  <option value="blog-small-thumb" <?php if($cs_blog_view == 'blog-small-thumb'){echo 'selected="selected"';}?>><?php _e('Blog Small Thumb','dir');?></option>
                                  <option value="blog-medium" <?php if($cs_blog_view == 'blog-medium'){echo 'selected="selected"';}?>><?php _e('Blog Medium','dir');?></option>
                                  <option value="blog-lrg" <?php if($cs_blog_view == 'blog-lrg'){echo 'selected="selected"';}?>><?php _e('Blog Large','dir');?></option>
                                  <option value="blog-mesnory" <?php if($cs_blog_view == 'blog-mesnory'){echo 'selected="selected"';}?>><?php _e('Blog Mesnory','dir');?></option>
                                  <option value="blog-grid" <?php if($cs_blog_view == 'blog-grid'){echo 'selected="selected"';}?>><?php _e('Blog Grid','dir');?></option>
                                  <option value="blog-box" <?php if($cs_blog_view == 'blog-box'){echo 'selected="selected"';}?>><?php _e('Blog Box','dir');?></option>
                                  <option value="blog-crousel" <?php if($cs_blog_view == 'blog-crousel'){echo 'selected="selected"';}?>><?php _e('Blog Crousel','dir');?></option>
                                </select>
                              </div>
                            </div>
                            <div class="left-info">
                      ...
                      <ul class="form-elements">
                          <li class="to-label">
                            <label> <?php _e('Filterable','dir'); ?> </label>
                          </li>
                          <li class="to-field">
                            <div class="input-sec">
                              <div class="select-style">
                                <select name="cs_blog_filterable[]" class="dropdown">
                                  <option value="yes" <?php if($cs_blog_filterable=="yes")echo "selected";?>><?php _e('Yes','dir'); ?></option>
                                  <option value="no" <?php if($cs_blog_filterable=="no")echo "selected";?> ><?php _e('No','dir'); ?></option>
                                </select>
                              </div>
                            </div>
                          </li>
