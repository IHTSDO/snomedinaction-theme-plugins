...
if ( ! function_exists( 'cs_general_settings_element' ) ) {
		function cs_general_settings_element(){
            ...
            <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Social Sharing','dir');?></label>
                  </li>
            ...
            <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Related Posts','dir');?></label>
                  </li>
                  <li class="to-field has_input">
                    <label class="pbwp-checkbox">
            ...
            <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Next Previous','dir');?></label>
                  </li>
                  <li class="to-field has_input">
                    <label class="pbwp-checkbox">
            ...
            <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Show Author','dir');?></label>
                  </li>
                  <li class="to-field has_input">
                    <label class="pbwp-checkbox">
...
if ( ! function_exists( 'cs_subheader_element' ) ) {
    function cs_subheader_element(){
        ...
        $cs_map    = '[cs_map column_size="1/1" cs_map_section_title=" Section Title " map_title=" Title " map_height="500" map_lat="31.5497" map_lon="74.3436" map_zoom="11" map_type="ROADMAP" map_info="Information Text here." map_info_width="300" map_info_height="300" map_marker_icon="" map_marker_icon1i0A="Browse" map_show_marker="true" map_controls="false" map_draggable="true" map_scrollwheel="true" map_border="yes" map_border_color="#dd3333" cs_map_class="cs_class" cs_map_animation="expandUp"]';
        ...
        if ( empty($cs_xmlObject->slider_position) ) $cs_slider_position = ""; else $cs_slider_position = htmlspecialchars($cs_xmlObject->slider_position);
        ...
        ?>
            <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Choose Sub-header','dir');?></label>
                  </li>
                  <li class="to-field">
                    <div class="input-sec">
                      ...
                      <div class="select-style">
                        <select name="header_banner_style" class="dropdown" onchange="javascript:cs_slider_element_toggle(this.value)">
                          <option <?php if(isset($header_banner_style) and $header_banner_style=="default_header" || $header_banner_style=="" ){echo "selected";}?> value="default_header" ><?php _e('Default Sub header','dir');?></option>
                          <option <?php if(isset($header_banner_style) and $header_banner_style=="breadcrumb_header" ) {echo "selected";}?> value="breadcrumb_header" ><?php _e('Custom Sub header','dir');?></option>
                          <option <?php if(isset($header_banner_style) and $header_banner_style=="custom_slider"){echo "selected";}?> value="custom_slider" ><?php _e('Revolution Slider','dir');?></option>
                          <option <?php if(isset($header_banner_style) and $header_banner_style=="map"){echo "selected";}?> value="map" ><?php _e('Map','dir');?></option>
                          <option <?php if(isset($header_banner_style) and $header_banner_style=="no-header"){echo "selected";}?> value="no-header" ><?php _e('No Sub header','dir');?></option>
                        </select>
                        <script>
            ...
            <div id="subheader-background-image" style="display:<?php if($header_banner_style=="breadcrumb_header")echo 'inline"'; else echo 'none';?>" >
                  <ul class="form-elements">
                    <li class="to-label">
                      <label><?php _e('Text Align','dir')?></label>
                    </li>
                    <li class="to-field">
                      <div class="input-sec">
                        <div class="select-style">
                          <select name="page_title_align">
                            <option value="left" <?php if (isset($cs_xmlObject->page_title_align) and $cs_xmlObject->page_title_align == "left") echo 'selected="selected"';?>><?php _e('Left','dir');?></option>
                            <option value="right" <?php if (isset($cs_xmlObject->page_title_align) and $cs_xmlObject->page_title_align == "right") echo 'selected="selected"';?>><?php _e('Right','dir');?></option>
                            <option value="center" <?php if (isset($cs_xmlObject->page_title_align) and $cs_xmlObject->page_title_align == "center") echo 'selected="selected"';?>><?php _e('Center','dir');?></option>
                          </select>
                        </div>
                      </div>
                    </li>
                  ...
                  <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Sub Heading','dir');?></label>
                  </li>
                  <li class="to-field">
                    <div class="input-sec">
                  ...
                  <ul class="form-elements">
                    <li class="to-label">
                      <label><?php _e('Breadcrumbs','dir');?></label>
                    </li>
                    <li class="to-field">
                      <label class="pbwp-checkbox">
                  ...
                  <ul class="form-elements">
                    <li class="to-label">
                      <label><?php _e('Padding','dir');?></label>
                    </li>
                    <li class="to-field">
                      <div class="input-sec">
                        <div class="select-style">
                          <select name="subheader_padding_switch" onchange="javascript:cs_hide_show_toggle(this.value,'cs_padding_type','page_options')">
                            <option value="default" <?php if (isset($cs_xmlObject->subheader_padding_switch) and $cs_xmlObject->subheader_padding_switch == "default") echo 'selected="selected"';?>><?php _e('Default','dir');?></option>
                            <option value="custom" <?php if (isset($cs_xmlObject->subheader_padding_switch) and $cs_xmlObject->subheader_padding_switch == "custom") echo 'selected="selected"';?>><?php _e('Custom','dir');?></option>        
                          </select>           
                        </div>
                      </div>
                    </li>
              ...
              <div id="cs_padding_type" style=" <?php if ( isset($subheader_padding_switch) && $subheader_padding_switch =='custom' ){ echo 'display:block'; } else { echo 'display:none';}?>">
                      <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Padding Top','dir');?></label></li>
                        <li class="to-field">
                            ...
                            <p><?php _e('Set the top padding (In PX)','dir');?></p>
                        </li>
                      </ul>
                      <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Padding Bottom','dir');?></label></li>
                        <li class="to-field">
                            ...
                            <p><?php _e('Set the bottom padding (In PX)','dir');?></p>
                        </li>
                      </ul>
              </div>
                  <ul class="form-elements">
            ...
            <div id="default_header_div" <?php  if( ( $header_banner_style=="no-header" || $header_banner_style=="custom_slider" ||  $header_banner_style=="map" ) && $header_banner_style != "" ) { echo 'style="display:none;"';}?>>
                <ul class="form-elements">
                      <li class="to-label">
                        <label><?php _e('Show Image','dir');?></label>
                      </li>
                      <li class="to-field">
                        <label class="pbwp-checkbox">
            ...
            <div class="page-wrap" style="overflow:hidden; display:<?php echo cs_allow_special_char($header_banner_image) && trim($header_banner_image) !='' ? 'inline' : 'none';?>" id="header_banner_image<?php echo cs_allow_special_char($rand_id)?>_box" >
                  <div class="gal-active">
                    ...
                    <ul class="form-elements">
                      <li class="to-label">
                        <label><?php _e('Parallax background Image','dir');?> </label>
                      </li>
                      <li class="to-field">
                        <label class="pbwp-checkbox">
            ...
            <div id="subheader_custom_slider" <?php if(isset($header_banner_style) && $header_banner_style != '' && $header_banner_style == "custom_slider"){echo 'style="display:block"';} else {echo 'style="display:none"';} ?> >
              <ul class="form-elements">
                    <li class="to-label">
                      <label><?php _e('Select Slider','dir');?></label>
                    </li>
                    <li class="to-field">
                      <div class="select-style">
                      ...
                      <div class="left-info">
                        <p><?php _e('Please select Revolution Slider if already included in package. Otherwise buy Sliders from','dir');?> <a href="<?php _e('http://codecanyon.net/','dir');?>" target="_blank"><?php _e('Code canyon','dir');?></a><?php _e('But its optional','dir');?> </p>
                      </div>
                    </li>
              </ul>
              <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('Select Slider Position','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="select-style">
                   <select name="slider_position" id="slider_position">
                    <option value="below" <?php echo cs_allow_special_char($cs_slider_position) == 'below' ? 'selected="selected"' : '' ;?>><?php _e('Below Header','dir');?></option>
                      <option value="above" <?php echo cs_allow_special_char($cs_slider_position) == 'above' ? 'selected="selected"' : '' ;?>><?php _e('Above Header','dir');?></option>
                   </select>
                  </div>
                </li>
              </ul>
            ...
            <div id="subheader_map" <?php if(isset($header_banner_style) && $header_banner_style != '' && $header_banner_style == "map"){echo 'style="display:block"';} else {echo 'style="display:none"';} ?> >
              <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('Custom Map Short Code','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
                  ...
                  <div class="left-info">
                    <p><?php _e('Please Add/Edit the short code for Map.','dir');?></p>
                  </div>
                </li>
              </ul>
            </div>
            <div id="subheader_no_header" <?php if(isset($header_banner_style) && $header_banner_style != '' && $header_banner_style == "no-header"){echo 'style="display:block"';} else {echo 'style="display:none"';} ?> >
              <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('Header Border Color','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
    ...
    <div class="input-sec">
      <div class="select-style">
        <select name="cs_background_option" class="dropdown"  onchange="javascript:cs_background_settings_toggle(this.value)">
          <option <?php if($cs_background_option=='no-image') echo "selected";?> value="no-image"><?php _e('No Image','dir');?> </option>
          <option <?php if($cs_background_option=='custom-background-image') echo "selected";?> value="custom-background-image"><?php _e('V1 Custom Background Image','dir');?> </option>
          <option <?php if($cs_background_option=='big-image-zoom') echo "selected";?> value="big-image-zoom"><?php _e('V2 Big Image Zoom','dir');?> </option>
          <option <?php if($cs_background_option=='fade-slider') echo "selected";?> value="fade-slider"><?php _e('V3 Fade Slider','dir');?></option>
          <option <?php if($cs_background_option=='left-slider')echo "selected";?> value="left-slider"><?php _e('V4 Left Slide','dir');?></option>
          <option  <?php if($cs_background_option=='background_video')echo "selected";?> value="background_video" ><?php _e('V6 Video','dir');?></option>
        </select>
      </div>
    </div>
  </li>
...
<div class="form-elements meta-body noborder" style=" <?php if($cs_background_option == "background_video"){echo "display:block";}else echo "display:none";?>" id="home_v2" >
      ...
      <ul class="form-elements noborder">
        <li class="to-label">
          <label><?php _e('Choose Mute','dir');?></label>
        </li>
        <li class="to-field">
          <div class="input-sec">
            <div class="select-style">
              <select name="cs_home_v2_video_mute" class="dropdown">
                <option value="Yes" <?php if($cs_home_v2_video_mute == "Yes"){ echo 'selected';}?>><?php _e('Yes','dir');?> </option>
                <option value="No" <?php if($cs_home_v2_video_mute == "No"){ echo 'selected';}?>><?php _e('No','dir');?> </option>
              </select>
            </div>
          </div>
        </li>
...
<div class="form-elements meta-body noborder" style=" <?php if($cs_background_option == "big-image-zoom" || $px_theme_option['varto_bg_option'] == "fade-slider" ||  $px_theme_option['varto_bg_option'] == "left-slider"){echo "display:block";}else echo "display:none";?>" id="home_v4" >
      <ul class="form-elements noborder">
        <li class="to-label">
          <label><?php _e('Chose Slider/Gallery','dir');?></label>
        </li>
        <li class="to-field">
          <div class="input-sec">
            <div class="select-style">
          ...
          <div class="left-info">
            <p><?php _e('Slider/Gallery images resolution should be full size. Create new Slider/Gallery from','dir');?> <a style="color:#06F; text-decoration:underline;" href="<?php echo get_site_url(); ?>/wp-admin/post-new.php?post_type=cs_gallery"><?php _e('here','dir');?></a></p>
          </div>
        </li>
      </ul>
</div>
...
if ( ! function_exists( 'cs_seo_settitngs_element' ) ) {
    function cs_seo_settitngs_element(){
        ...
        <ul class="form-elements ">
          <li class="to-label">
            <label><?php _e('seo title','dir');?> </label>
          </li>
          <li class="to-field">
            <div class="input-sec">
        ...
        <ul class="form-elements ">
          <li class="to-label">
            <label><?php _e('seo Description','dir');?></label>
          </li>
          <li class="to-field">
            <div class="input-sec">
        ...
        <ul class="form-elements ">
          <li class="to-label">
            <label><?php _e('Seo Keywords','dir');?></label>
          </li>
          <li class="to-field">
            <div class="input-sec">
...
if ( ! function_exists( 'cs_header_postition_element' ) ) {
    function cs_header_postition_element(){
        ...
        <ul class="form-elements ">
              <li class="to-label">
                <label><?php _e('Header Background','dir');?></label>
              </li>
              <li class="to-field">
                <div class="input-sec">
                      <select name="header_bg_options" class="dropdown" onchange="javascript:cs_header_option(this.value)">
                        <option <?php cs_selected($header_bg_options,'none') ?> value="none" ><?php _e('None','dir');?></option>
                        <option <?php cs_selected($header_bg_options,'cs_rev_slider') ?> value="cs_rev_slider" ><?php _e('Revolution Slider','dir');?></option>
                        <option <?php cs_selected($header_bg_options,'cs_bg_image_color') ?> value="cs_bg_image_color" ><?php _e('Background Image / Background Color','dir');?></option>
                    </select>
                </div>
              </li>
        </ul>
...
if ( ! function_exists( 'cs_customstyling_element' ) ) {
    function cs_customstyling_element(){
        ...
        ?>
            <ul class="form-elements noborder">
              <li class="to-label">
                <label><?php _e('Custom Classes','dir');?></label>
              </li>
              <li class="to-field">
                <div class="input-sec">
            ...
            <ul class="form-elements noborder">
              <li class="to-label">
                <label><?php _e('Custom IDs','dir');?></label>
              </li>
              <li class="to-field">
                <div class="input-sec">
            ...
            <ul class="form-elements noborder">
              <li class="to-label">
                <label><?php _e('Sub Header Color','dir');?></label>
              </li>
              <li class="to-field">
                <div class="input-sec">
            ...
            <ul class="form-elements noborder">
              <li class="to-label">
                <label><?php _e('Header Color','dir');?></label>
              </li>
              <li class="to-field">
                <div class="input-sec">
...
if ( ! function_exists( 'cs_sidebar_layout_options' ) ) {
    function cs_sidebar_layout_options(){
            global $post , $cs_xmlObject,$cs_theme_options, $cs_page_option;
            ...
            <?php /*?> <ul class="form-elements">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Choose Sidebar','dir');?></label>
                  </li>
                  <li class="to-field">
                    <div class="input-sec">
                      <div class="meta-input pattern">
                        <div class='radio-image-wrapper'>
                          ...
                          <span class="title-theme"><?php _e('full width','dir');?></span> </div>
                        <div class='radio-image-wrapper'>
                          ...
                          <span class="title-theme"><?php _e('Sidebar Right','dir');?></span> </div>
                        <div class='radio-image-wrapper'>
                          ...
                          <span class="title-theme"><?php _e('Sidebar Left','dir');?></span> </div>
                      </div>
                    </div>
                  </li>
                </ul>
                ...
                <?php
                    ...
                    <div class="left-info">
                      <p> <?php _e('Add New Sidebar.','dir');?><a href="<?php echo admin_url();?>themes.php?page=cs_options_page#tab-sidebar-show" target="_blank"><?php _e('Click Here','dir');?></a></p>
                    </div>
                  </li>
                </ul>
                <ul class="form-elements meta-body" style=" <?php if($cs_page_sidebar_right == ""){echo "display:none";}else echo "display:block";?>" id="sidebar_right" >
                  ...
                  <li class="to-field">
                    ...
                    <div class="left-info">
                      <p><?php _e('Add New Sidebar.','dir');?> <a href="<?php echo admin_url();?>themes.php?page=cs_options_page#tab-sidebar-show" target="_blank"><?php _e('Click Here','dir');?>C</a></p>
...
function cs_pagebuilder_themeoptions(){
	...
	if($current_user->user_login =='directory-admin'){
	 ?>
    <ul class="form-elements">
      <li class="to-label">
        <label> <?php _e('Page Options','dir'); ?> </label>
      </li>
      <li class="to-field">
        <div class="input-sec">
          <div class="select-style">
             ...
             <select name="cs_page_options" class="select_dropdown" id="cs_page_options">
                    <option value="default"><?php _e('default','dir');?></option>
                    <?php
                        if(isset($cs_page_option['theme_options'])){
                            
                            foreach($cs_page_option['theme_options']['select'] as $key=>$options){
                                ?>
...
if ( ! function_exists( 'cs_footer_settings_element' ) ) {
    function cs_footer_settings_element(){ 
        ...
        ?>
            ...
            <ul class="form-elements">
              <li class="to-label">
                <label><?php _e('Background Skin','dir');?></label>
              </li>
              <li class="to-field">
                <div class="input-sec">
                  <div class="select-style">
                    <select name="cs_background_skin">
                      <option value="light" <?php if($cs_background_skin == 'light'){echo 'selected="selected"';}?>><?php _e('Light','dir');?></option>
                      <option value="dark" <?php if($cs_background_skin == 'dark'){echo 'selected="selected"';}?>><?php _e('Dark','dir');?></option>
                    </select>
                  </div>
                </div>
              </li>
