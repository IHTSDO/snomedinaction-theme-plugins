                    ...
                    <div class="tabs vertical">
                        <nav class="admin-navigtion">
                            <ul id="myTab" class="nav nav-tabs">
                                <li class="active"><a href="#tab-general-settings" data-toggle="tab"><i class="icon-toggle-right"></i><?php _e('General Settings','dir');?></a></li>
                                <li><a href="#tab-subheader-options" data-toggle="tab"><i class="icon-list-alt"></i><?php _e('Sub Header Options','dir');?></a></li>
                                <?php if($cs_builtin_seo_fields == 'on'){?>
                                <li><a href="#tab-seo-advance-settings" data-toggle="tab"><i class="icon-dribbble"></i> <?php _e('Seo Options','dir');?></a></li>
                                <?php }?>
                                <li><a href="#tab-post-options" data-toggle="tab"><i class="icon-list-alt"></i> <?php _e('Post Settings','dir');?> </a></li>                                
                          </ul>
                      </nav>
            ...
            if( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) return;
             ...
             if ( ! function_exists( 'cs_blog_post_general_options' ) ) {
                function cs_blog_post_general_options() {
                    ...
                    <li class="to-label"><label><?php _e('Thumbnail View','dir');?></label></li>
                    <li class="to-field">
                        <div class="input-sec">
                            <div class="select-style">
                                <select name="post_thumb_view" class="dropdown" onchange="javascript:new_toggle(this.value)">
                                    <option <?php if($post_thumb_view=="Single Image")echo "selected";?> ><?php _e('Single Image','dir');?></option>
                                    <option <?php if($post_thumb_view=="Slider")echo "selected";?> ><?php _e('Slider','dir');?></option>
                                    <option <?php if($post_thumb_view=="Audio")echo "selected";?> ><?php _e('Audio','dir');?></option>
                                    <option <?php if($post_thumb_view=="Video")echo "selected";?> value="Video" ><?php _e('Soundcloud','dir');?></option>
                                </select>
                            </div>
                        </div>
                        <div class="left-info">
                            <p id="post_thumb_image" style="display:<?php if($post_thumb_view=="Single Image" or $post_thumb_view == "")echo 'inline"';else echo 'none';?>"><?php _e('Use Featured Image as Thumbnail','dir');?></p>
                        </div>
                    </li>
                        <ul class="form-elements" id="post_thumb_audio" style="display:<?php if($post_thumb_view=="Audio")echo 'inline"';else echo 'none';?>" >
                            <li class="to-label"><label><?php _e('Audio Url','dir');?></label></li>
                            <li class="to-field">
                                <div class="input-sec">
                                ...
                                <div class="left-info">
                                    <p><?php _e('Enter Specific Audio URL (Youtube, Vimeo and all otheres wordpress supported)','dir');?></p>
                                </div>
                            </li>
                        </ul>
                        <ul class="form-elements" id="post_thumb_video" style="display:<?php if($post_thumb_view=="Video")echo 'inline"';else echo 'none';?>" >                            
                            <li class="to-label"><label><?php _e('Soundcloud Url','dir');?></label></li>
                            <li class="to-field">
                                <div class="input-sec">
                                ...
                                <div class="left-info">
                                    <p><?php _e('Enter Specific Soundcloud url','dir');?></p>
                                </div>
                            </li>
                        </ul>
                </ul>
                    ...
                    <ul class="form-elements noborder">
                        <li class="to-label"><label><?php _e('Inside Post Thumbnail View','dir');?></label></li>
                        <li class="to-field">
                            <div class="input-sec">
                                <div class="select-style">
                                    <select name="inside_post_thumb_view" class="dropdown" onchange="javascript:new_toggle_inside_post(this.value)">
                                        <option <?php if($inside_post_thumb_view=="Single Image")echo "selected";?> ><?php _e('Single Image','dir');?></option>
                                        <option <?php if($inside_post_thumb_view=="Audio")echo "selected";?> ><?php _e('Audio','dir');?></option>
                                        <option <?php if($inside_post_thumb_view=="Video")echo "selected";?> value="Video"><?php _e('Video/Soundcloud','dir');?></option>
                                        <option <?php if($inside_post_thumb_view=="Slider")echo "selected";?> ><?php _e('Slider','dir');?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="left-info">
                                <p id="inside_post_thumb_image" style="display:<?php if($inside_post_thumb_view=="Single Image" or $inside_post_thumb_view=="")echo 'inline"';else echo 'none';?>"><?php _e('Use Featured Image as Thumbnail','dir');?></p>
                            </div>
                        </li>
                            ...
                            <ul class="form-elements" id="inside_post_thumb_video" style="display:<?php if($inside_post_thumb_view=="Video")echo 'inline"';else echo 'none';?>" >
                                <li class="to-label"><label><?php _e('Thumbnail Video Url','dir');?></label></li>
                                <li class="to-field">
                                    <div class="input-sec">
                                    ...
                                    <div class="left-info">
                                        <p><?php _e('Enter Specific Video URL (Youtube, Vimeo and all otheres wordpress supported) OR you can select it from your media library','dir');?></p>
                                    </div>
                                </li>
                            </ul>
                    </ul>
