...
if (!function_exists('cs_image_shortcode')) {
    function cs_image_shortcode($atts, $content = "") {
        ...
        $html    .= '<div '.$CustomId.' class="image-frame '.$image_style.' '.$cs_custom_animation.'">';
		...
		$html = '<div '.$CustomId.' class="' . $column_class . ' ' . $cs_image_custom_class . ' ' . $cs_image_custom_animation . '">'.$section_title.' '.$html.'</div>';
