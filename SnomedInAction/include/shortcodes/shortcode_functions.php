...
if (!function_exists('cs_banner_ads_shortcode')) {
    ...
    add_shortcode( 'cs_ads', 'cs_banner_ads_shortcode' );
}
//=====================================================================
...
if (!function_exists('cs_content_render')) {
    function cs_content_render($atts, $content = ""){
        ...
        ob_start();
         the_content();
         wp_link_pages( array( 'before' => '<div class="page-links"><span class="page-links-title">' . __( 'Pages:', 'dir' ) . '</span>', 'after' => '</div>', 'link_before' => '<span>', 'link_after' => '</span>' ) );
         ...
         ?>
            ...
            <div class="cs-content-wrap">
                <header class="cs-heading-title">
                  <h2 class=" cs-section-title"><?php _e('About','dir');?> <?php _e('Author','dir');?></h2>
                </header>
                     ...
                     <div class="text">
                        ...
                        <?php if(isset($social) && $social == 'on'){?>
                            <ul class="socialmedia group">
                                ...
                                <?php } ?>
                                <li class="share"><a href="#"><?php _e('View All Posts', 'dir'); ?></a></li>
                           </ul>
                        <?php }?>
                    </div>
                </div>
...
if (!function_exists('cs_edit_link_render')) {
    function cs_edit_link_render($atts, $content = ""){
        global $post;
        ob_start();
        edit_post_link( __( 'Edit','dir'), '<li>', '</li>' ); 
...
if (!function_exists('cs_author_render')) {
    function cs_author_render($atts, $content = ""){
        global $post;
        ob_start();
        printf( __('%s','dir'), '<a href="'.get_author_posts_url(get_the_author_meta('ID')).'" >'.get_the_author().'</a>' );
    ...
    $dcpt_elements_array = array();
        $shortcode_array = array(
                 ...
                 'call_to_action'=>array(
                        'title'=>__('Call to Action','dir'),
                        'name'=>'call_to_action',
                        'icon'=>'icon-info-circle',
                        'categories'=>'commonelements',
                 ),
                 'clients'=>array(
                        'title'=>__('Clients','dir'),
                        'name'=>'clients',
                        'icon'=>'icon-user3',
                        'categories'=>'loops',
                 ),
                 ...
                 'counter'=>array(
                        'title'=>__('Counter','dir'),
                        'name'=>'counter',
                        'icon'=>'icon-clock-o',
                        'categories'=>'commonelements',
                 ),
                 'divider'=>array(
                        'title'=>__('Divider','dir'),
                        'name'=>'divider',
                        'icon'=>'icon-ellipsis-h',
                        'categories'=>'typography misc',
                 ),
                  'dropcap'=>array(
                        'title'=>__('Dropcap','dir'),
                        'name'=>'dropcap',
                        'icon'=>'icon-bold',
                        'categories'=>'typography misc',
                 ),
                 ...
                 'heading'=>array(
                        'title'=>__('Heading','dir'),
                        'name'=>'heading',
                        'icon'=>'icon-h-square',
                        'categories'=>'typography misc',
                 ),
                 'highlight'=>array(
                        'title'=>__('Highlight','dir'),
                        'name'=>'highlight',
                        'icon'=>'icon-pencil3',
                        'categories'=>'typography misc',
                 ),
                 ...
                 'infobox'=>array(
                        'title'=>__('Info box','dir'),
                        'name'=>'infobox',
                        'icon'=>'icon-info-circle',
                        'categories'=>' contentblocks',
                 ),
                 'image'=>array(
                        'title'=>__('Image Frame','dir'),
                        'name'=>'image',
                        'icon'=>'icon-photo2',
				 ...
				 'multiple_services'=>array(
                        'title'=>__('Multiple Services','dir'),
                        'name'=>'multiple_services',
                        'icon'=>'icon-database2',
                        'categories'=>'loops misc',
                 ),
                 'progressbars'=>array(
                        'title'=>__('Progressbars','dir'),
                        'name'=>'progressbars',
                        'icon'=>'icon-list-alt',
                        'categories'=>' commonelements',
                 ),
                 'piecharts'=>array(
                        'title'=>__('Piecharts','dir'),
                        'name'=>'piecharts',
                        'icon'=>'icon-pie2',
                        'categories'=>'commonelements',
                 ),
                 'promobox'=>array(
                        'title'=>__('Promobox','dir'),
                        'name'=>'promobox',
                        'icon'=>'icon-bullhorn',
                        'categories'=>' mediaelement',
                 ),
                 'pricetable'=>array(
                        'title'=>__('Pricetable','dir'),
                        'name'=>'pricetable',
                        'icon'=>'icon-table',
                        'categories'=>'commonelements',
                 ),
				 ...
				 'mailchimp'=>array(
                        'title'=>__('Mailchimp','dir'),
                        'name'=>'mailchimp',
                        'icon'=>'icon-envelope7',
                        'categories'=>'commonelements',
                 ),
                 'members'=>array(
                        'title'=>__('Members','dir'),
                        'name'=>'members',
                        'icon'=>'icon-user-add',
                        'categories'=>'loop misc    ',
                 ),
                 'tabs'=>array(
                        'title'=>__('Tabs','dir'),
                        'name'=>'tabs',
         ...
         if ( function_exists( 'cs_pb_directory' ) ) {
             $shortcode_array['directory'] = array(
                                            'title'=>__('Directory','dir'),
                                            'name'=>'directory',
                                            'icon'=>'icon-question-circle',
                                            'categories'=>'loops misc',
                                     );
         ...
         if ( function_exists( 'cs_pb_directory_search' ) ) {
             $shortcode_array['directory_search'] = array(
                                            'title'=>__('Directory Search','dir'),
                                            'name'=>'directory_search',
                                            'icon'=>'icon-search3',
                                            'categories'=>'loops misc',
                                     );
         }
         if ( function_exists( 'cs_pb_directory_map' ) ) {
             $shortcode_array['directory_map'] = array(
                                            'title'=>__('Directory Map','dir'),
                                            'name'=>'directory_map',
                                            'icon'=>'icon-search',
                                            'categories'=>'loops misc',
                                     );
         ...
         if ( function_exists( 'cs_pb_directory_categories' ) ) {
             $shortcode_array['directory_categories'] = array(
                                            'title'=>__('Directory Categories','dir'),
    ...
    ?> 
        <div class="cs-page-composer  <?php echo sanitize_html_class($shortcode);?> composer-<?php echo intval($rand) ?>" id="composer-<?php echo intval($rand) ?>" style="display:none">
            ...
            <div class="cs-heading-area">
                 <h5>
                    <i class="icon-plus-circle"></i> <?php _e('Add Element','dir');?>
                </h5>
         ...
         <div class="cs-filter-content shortcode">
            <p><input type="text" id="quicksearch<?php echo intval($rand) ?>" placeholder="<?php _e('Search','dir');?>" /></p>
              <div class="cs-filtermenu-wrap">
                <h6><?php _e('Filter by','dir');?></h6>
                <ul class="cs-filter-menu" id="filters<?php echo intval($rand) ?>">
                  <li data-filter="all" class="active"><?php _e('Show all','dir');?></li>
       ...
       <?php 
        if(isset($shortcode) && $shortcode <> ''){
            ...
            <i class="icon-plus-circle"></i> <?php _e('CS: Insert shortcode','dir');?></a>
            <?php
        }
    }
}
    ...
    function cs_shortcode_element_size($column_size =''){
        ?>
            <ul class="form-elements">
                <li class="to-label"><label><?php _e('Size','dir');?></label></li>
                <li class="to-field select-style">
                    <select class="column_size" id="column_size" name="column_size[]">
                        <option value="1/1" <?php if($column_size == '1/1'){echo 'selected="selected"';}?>><?php _e('Full width','dir');?></option>
                        <option value="1/2" <?php if($column_size == '1/2'){echo 'selected="selected"';}?>><?php _e('One half','dir');?></option>
                        <option value="1/3" <?php if($column_size == '1/3'){echo 'selected="selected"';}?>><?php _e('One third','dir');?></option
                        ><option value="2/3" <?php if($column_size == '2/3'){echo 'selected="selected"';}?>><?php _e('Two third','dir');?></option>
                        <option value="1/4" <?php if($column_size == '1/4'){echo 'selected="selected"';}?>><?php _e('One fourth','dir');?></option>
                        <option value="3/4" <?php if($column_size == '3/4'){echo 'selected="selected"';}?>><?php _e('Three fourth','dir');?></option>
                    </select>
                    <p><?php _e('Select column width. This width will be calculated depend page width','dir');?></p>
                </li>                  
            </ul>
        <?php
    }
        ...
        ?>
            <ul class="form-elements">
                ...
                <li class="to-field">
                    ...
                    <p><?php _e('Use this option if you want to use specified Class for this element','dir');?></p>
                </li>
            </ul>
            <?php $custom_animation_array = array('fade'=>'Fade','slide'=>'Slide','left-slide'=>'left Slide');?>
            <ul class="form-elements">
                <li class="to-label"><label><?php _e('Animation Class','dir');?><?php echo sanitize_text_field($cs_custom_animation);?></label></li>
                <li class="to-field select-style">
                    <select class="dropdown" name="cs_custom_animation[]">
                        <option value=""><?php _e('Animation Class','dir');?></option>
                        <?php 
        ...
        if(isset($_POST['shortcode_element']) && $_POST['shortcode_element']){
            if($_POST['shortcode_element'] == 'services'){
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo intval( $rand_id);?>">
                    <header>
						<h4>
							<i class='icon-arrows'></i><?php _e('Service','dir');?>
						</h4>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Service Title','dir');?></label></li>
                        <li class='to-field'> <div class='input-sec'><input class='txtfield' type='text' name='service_title[]' /></div>
                        <div class='left-info'><p><?php _e('Title of the Service','dir');?></p></div>
                        </li>
                    </ul>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Service View:','dir');?></label></li>
                        <li class='to-field select-style'> <div class='input-sec'><select name='service_type[]' class='dropdown'>
                        <option value='size_large'><?php _e('Large Boxed','dir');?></option>
                        <option value='size_large_normal'><?php _e('Large Normal','dir');?></option>
                        <option value='size_circle'><?php _e('Circle','dir');?></option>
                        <option  value="size_medium" ><?php _e('Medium','dir');?></option>
                        <option value='size_small'><?php _e('Small','dir');?></option>
                        </select></div>
                        <div class='left-info'><p><?php _e('Type of the Service','dir');?></p></div>
                        </li>
                    </ul>
                     <ul class='form-elements' id="<?php echo intval( $rand_id);?>">
                            <li class='to-label'><label><?php _e('Font awsome Icon:','dir');?></label></li>
                            <li class="to-field">
                                <?php cs_fontawsome_icons_box('',$rand_id,'cs_service_icon');?>
                            </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Icon Postion','dir');?></label></li>
                        <li class="to-field select-style">
                            <select class="service_icon_postion" name="service_icon_postion[]">
                                <option value="left"><?php _e('left','dir');?></option>
                                <option value="right"><?php _e('Right','dir');?></option>
                                <option value="top"><?php _e('Top','dir');?></option>
                                <option value="center"><?php _e('Center','dir');?></option>
                            </select>
                        </li>                  
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Icon Type','dir');?></label></li>
                        <li class="to-field select-style">
                            <select class="service_icon_type" name="service_icon_type[]">
                                <option value="circle"><?php _e('Circle','dir');?></option>
                                <option value="square"><?php _e('Square','dir');?></option>
                            </select>
                        </li>                  
                    </ul>
                    <ul class="form-elements">
                          <li class="to-label">
                            <label><?php _e('Service background  Image','dir');?></label>
                          </li>
                          <li class="to-field">
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Service Link Url:','dir');?></label></li>
                        <li class='to-field'> <div class='input-sec'><input class='txtfield' type='text' name='service_link_url[]' /></div>
                        <div class='left-info'><p><?php _e('Service Link Url','dir');?></p></div>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Border','dir');?></label></li>
                        <li class="to-field select-style">
                            <select class="service_border" id="service_border" name="service_border[]">
                                <option value="yes"><?php _e('Yes','dir');?></option>
                                <option value="no"><?php _e('No','dir');?></option>
                            </select>
                        </li>                  
                    </ul>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Service Text:','dir');?></label></li>
                        <li class='to-field'>
							<div class='input-sec'>
                    ...
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Divider','dir');?></label></li>
                        <li class="to-field select-style">
                    ...
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Icon Color','dir');?></label></li>
                        <li class="to-field">
                            <input type="text" name="service_icon_color[]" class="bg_color"  value="" />
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Icon Background Color','dir');?></label></li>
                        <li class="to-field">
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo intval( $rand_id);?>">
                        ...
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Active','dir');?></label></li>
                            <li class='to-field select-style'>
								 <select name='accordion_active[]'>
								 	<option value="no"><?php _e('No','dir');?></option><option value="yes"><?php _e('Yes','dir');?></option>
								</select>
                            <div class='left-info'>
                        ...
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Accordion Title:','dir');?></label></li>
                            <li class='to-field'>
								<div class='input-sec'>
                        ...
                        <ul class='form-elements' id="<?php echo intval($rand_id);?>">
                            ...
                            <li class="to-field">
                                    ...
                                    <div class='left-info'>
                                      <p><?php _e('Select the font awsome Icons you would like to add to your menu items','dir');?></p>
                                    </div>
                            </li>
                        </ul>
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Accordion Text:','dir');?></label></li>
                            <li class='to-field'>
								<div class='input-sec'>
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo intval( $rand_id);?>">
                        ...
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Faq Title:','dir');?></label></li>
                            <li class='to-field'>
								<div class='input-sec'>
                        ...
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Faq Text:','dir');?></label></li>
                            <li class='to-field'>
								<div class='input-sec'>
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo intval( $rand_id);?>">
                        <header>
							<h4><i class='icon-arrows'></i><?php _e('Register','dir');?></h4>
							<a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove','dir');?></a>
						</header>
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Register Title:','dir');?></label></li>
                            <li class='to-field'>
								<div class='input-sec'>
                        ...
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('User Role:','dir');?></label></li>
                            <li class='to-field'>
								<div class="select-style">
									<select name='register_role[]'>
										<option value="<?php _e('subscriber','dir');?>"><?php _e('Subscriber','dir');?></option>
										<option value="<?php _e('staff','dir');?>"><?php _e('Staff','dir');?></option>
										<option value="<?php _e('member','dir');?>"><?php _e('Member','dir');?></option>
										<option value="<?php _e('instructor','dir');?>"><?php _e('Instructor','dir');?></option>
                            			<option value="<?php _e('customer','dir');?>"><?php _e('Customer','dir');?></option>
										<option value="<?php _e('contributor','dir');?>"><?php _e('Contributor','dir');?></option>
										<option value="<?php _e('author','dir');?>"><?php _e('Author','dir');?></option>
										<option value="<?php _e('editor','dir');?>"><?php _e('Editor','dir');?></option>
										<option value="<?php _e('administrator','dir');?>"><?php _e('Administrator','dir');?></option>
										</select>
								</div>
                            </li>
                        </ul>
                        ...
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Register Text:','dir');?></label></li>
                            <li class='to-field'>
							 <div class='input-sec'>
            ...
            ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp add_tabs  cs-pbwp-content'  id="cs_infobox_<?php echo intval( $rand_id);?>">
                                <header>
									<h4><i class='icon-arrows'></i><?php _e('Tab','dir');?></h4>
									<a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove','dir');?></a>
								</header>
                                <ul class='form-elements'>
                                    <li class='to-label'><label><?php _e('Active','dir');?></label></li>
                                    <li class='to-field'> 
                                        <div class="select-style">
											<select name='tab_active[]'>
												<option value="<?php _e('No','dir');?>"><?php _e('No','dir');?></option>
												<option value="<?php _e('yes','dir');?>"><?php _e('Yes','dir');?></option>
											</select>
										</div>
                                        <div class='left-info'>
                                          <p><?php _e('You can set the section that is active here by select dropdown','dir');?></p>
                                ...
                                <ul class='form-elements'>
                                    <li class='to-label'><label><?php _e('Tab Title:','dir');?></label></li>
                                    <li class='to-field'>
										<div class='input-sec'>
                                ...
                                <ul class='form-elements'>
                                    <li class='to-label'><label><?php _e('Tab Text:','dir');?></label></li>
                                    <li class='to-field'>
										<div class='input-sec'>
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content'  id="cs_infobox_<?php echo intval( $rand_id);?>">
                        ...
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Text','dir');?>:</label></li>
                            <li class='to-field'>
								<div class='input-sec'>
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($counter_count);?>">
                        ...
                        <ul class="form-elements">
                            <li class="to-label"><label><?php _e('Counter Title','dir');?></label></li>
                            <li class="to-field"><input type="text"  name="counter_title[]"  class="txtfield"  /></li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label"><label><?php _e('Type','dir');?></label></li>
                            <li class="to-field">
                                <div class="select-style">
                                    <select name="counter_style[]" class="dropdown" >
                                        <option value="one" ><?php _e('Counter Style One','dir');?></option>
                                        <option value="two" ><?php _e('Counter Style Two','dir');?></option>
                                        <option value="three" ><?php _e('Counter Style Three','dir');?></option>
                                        <option value="four" ><?php _e('Counter Style Four','dir');?></option>
                                     </select>
                                 </div>
                            </li>
                        </ul>
                        ...
                        <ul class="form-elements">
                            <li class="to-label"><label><?php _e('Choose Icon','dir');?></label></li>
                            <li class="to-field">
                                <div class="select-style">
                                    <select name="counter_icon_type[]" class="dropdown" onchange="cs_counter_image(this.value,'<?php echo esc_js($counter_count)?>','')">
                                        <option <?php if($counter_item->counter_icon_type=="icon")echo "selected";?> value="icon" ><?php _e('Icon','dir');?></option>
                                        <option <?php if($counter_item->counter_icon_type=="image")echo "selected";?> value="image" ><?php _e('Image','dir');?></option>
                                     </select>
                                 </div>
                            </li>
                        </ul>
                        ...
                        <div class="selected_icon_type" id="selected_icon_type<?php echo intval($counter_count)?>">
                             <ul class='form-elements' id="<?php echo intval($counter_count);?>">
                                <li class='to-label'><label><?php _e('Fontawsome Icon','dir');?></label></li>
                                <li class="to-field">
                ...
                <?php    } 
                    ...
                    <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($rand_id);?>">
                            ...
                            <ul class='form-elements'>
                                <li class='to-label'><label><?php _e('List Item','dir');?></label></li>
                                <li class='to-field'>
									<div class='input-sec'>
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval( $rand_id);?>">
                            <header><h4><i class='icon-arrows'></i><?php _e('Infobox Item(s)','dir');?></h4> 
                        ...
                        <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Title','dir');?></label></li>
                            <li class='to-field'>
								<div class='input-sec'>
                         ...
                         <ul class='form-elements'>
                            <li class='to-label'><label><?php _e('Short Description','dir');?></label></li>
                            <li class='to-field'>
								<div class='input-sec'>
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval( $rand_id);?>">
                        <header>
							<h4><i class='icon-arrows'></i><?php _e('Album Item(s)','dir');?></h4>
							<a href='#' class='deleteit_node'><i class='icon-minus-circle'></i>Remove</a>
						</header>
                        <ul class="form-elements">
                            <li class="to-label"><label><?php _e('Track Title','dir');?></label></li>
                            <li class="to-field">
                        ...
                        <ul class="form-elements">
                            <li class="to-label"><label><?php _e('Track MP3 URL','dir');?></label></li>
                            <li class="to-field">
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo cs_allow_special_char($clients_count);?>">
                        <header>
							<h4><i class='icon-arrows'></i>Client</h4>
							<a href='#' class='deleteit_node'><i class='icon-minus-circle'></i>Remove</a>
						</header>
                        <ul class="form-elements">
                          <li class="to-label">
                        ...
                        <ul class="form-elements">
                            <li class="to-label"><label><?php _e('Website URL','dir');?></label></li>
                            <li class="to-field">
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo cs_allow_special_char($multiple_services_count);?>">
                        <header>
							<h4><i class='icon-arrows'></i><?php _e('Multiple Service','dir');?></h4>
							<a href='#' class='deleteit_node'><i class='icon-minus-circle'></i>Remove</a>
						</header>
                        <ul class="form-elements">
                          <li class="to-label">
                        ...
                        <ul class="form-elements">
                          ...
                          <li class="to-field">
                            ...
                            <input name="cs_multiple_service_logo<?php echo cs_allow_special_char($multiple_services_count)?>"  type="button" class="uploadMedia left" value="Browse"/>
                          </li>
                        </ul>
                        ...
                        <ul class="form-elements">
                          ...
                          <li class="to-field">
                            <input type="text" id="cs_multiple_service_btn" class="" name="cs_multiple_service_btn[]" value="" />
                          </li>
                        </ul>
                        <ul class="form-elements">
                          <li class="to-label">
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content' id="cs_infobox_<?php echo intval( $rand_id);?>">
                        <header>
							<h4><i class='icon-arrows'></i><?php _e('Progressbars','dir');?></h4>
							<a href='#' class='deleteit_node'><i class='icon-minus-circle'></i>Remove</a>
						</header>
                        <ul class="form-elements">
                            <li class="to-label"><label><?php _e('ProgressBars Title','dir');?></label></li>
                            <li class="to-field">
                                <input type="text" name="progressbars_title[]" class="txtfield" value="" />
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label"><label><?php _e('Skill (in percentage)','dir');?></label></li>
                            <li class="to-field">
                                ...
                                <p><?php _e('Set the Skill (In %)','dir');?></p>
                            </li>
                        </ul>
                        <ul class="form-elements">
                            <li class="to-label"><label><?php _e('ProgressBars Color','dir');?></label></li>
                            <li class="to-field">
                ...
                ?>
                    <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($offer_count);?>">
                        <header>
							<h4><i class='icon-arrows'></i><?php _e('Offer Slider Item','dir');?></h4>
							<a href='#' class='deleteit_node'><i class='icon-minus-circle'></i>Remove</a>
						</header>
                        <ul class="form-elements">
                          <li class="to-label">
                          ...
                          <div class="gal-active">
                            <div class="dragareamain" style="padding-bottom:0px;">
                              <ul id="gal-sortable">
                                <li class="ui-state-default" id="">
                                  <div class="thumb-secs">
								   <img src=""  id="cs_slider_image<?php echo intval($offer_count)?>_img" width="100" height="150"  />
                        ...
                        <ul class="form-elements">
                          <li class="to-label">
                            <label><?php _e('Link Title','dir');?></label>
                          </li>
                          <li class="to-field">
