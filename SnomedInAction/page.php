 ...
 */
    ...
    if (isset($cs_xmlObject) && count($cs_xmlObject) > 1) {
        ...
        $cs_counter_node = $column_no = 0;
          ...
          if (isset($cs_xmlObject->sidebar_layout) && $cs_sidebarLayout <> '' and $cs_sidebarLayout <> "none"){
              $fullwith_style = 'style="width:100%;"';
                $section_container_style_elements =' width: 100%;';
                echo '<div class="container">';
                	echo '<div class="row">';
						if (isset($cs_xmlObject->sidebar_layout) && $cs_sidebarLayout <> '' and $cs_sidebarLayout <> "none" and $cs_sidebarLayout == 'left') : ?>
    ...
    if (post_password_required()) {
           ...
           $image_url = cs_get_post_img_src($post->ID, $width, $height);
            if(get_the_content() <> '' || $image_url <> '')    {
                ...
                echo '<div class="page-section wp-content">
                        <!-- Container Start -->
                            <div  class="container">
                                <!-- Row Start -->
                                <div class="row">
                                    ...
                                    if (isset($image_url) && $image_url !=''){
										?>
										<a data-rel="prettyPhoto" href="<?php echo esc_url($image_url);?>" data-title="" rel="prettyPhoto">
											<figure>
        ...
        // ===================
		 ...
		 foreach ($cs_xmlObject->column_container as $column_container) {
            ...
            if (isset($cs_xmlObject->sidebar_layout) && $cs_sidebarLayout <> '' and $cs_sidebarLayout <> "none" and $cs_sidebarLayout == 'right') : ?>
                <aside class="page-sidebar">
