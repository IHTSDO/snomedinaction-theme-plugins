...
<div class="main-content-in">
        ...
        <h2>
			<?php
                if(isset($post_id) && !empty($post_id)){
                    _e('Update Project','directory');
                } else {
                    _e('Add Project','directory');
                }
             ?>
        </h2>
    </div>
  ...
  <input name="dir[directory_type_select]" type="hidden" value="123">
                                   
<input name="dir[directory_type_select]" id="directory_type_select_123" type="hidden" onchange="cs_directory_type_fields_frontend(this.value, '<?php if(isset($post_id))echo esc_js($post_id);?>', '<?php echo esc_js(admin_url('admin-ajax.php'), 'directory');?>', 'Front')" value="123" <?php echo esc_attr( $selected );?> data-price="0" onclick="cs_package_amount_sum('<?php echo admin_url('admin-ajax.php');?>', '0', '$', 'type' );">
                                   
                                   
 <input type="hidden" name="dir[directory_type_price]" id="cs-dir-type-price" value="0" />
                                ...
                                <li class="gallery-thumb">
                                  <div id="directory_images_container" style="cursor:default">
                                    <ul class="directory_images">
										...
										?>
										<input name="dir[directory_type_select]" id="directory_type_select"  type="hidden" value="123" >
