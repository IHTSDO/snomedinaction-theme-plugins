...
?>
    ...
    <div id="<?php echo esc_attr($column_class.$randomno);?>" style="display:none">
        <div class="cs-heading-area">
          <h5><?php _e('Edit Page Section','dir');?></h5>
        ...
        <div class="cs-pbwp-content">
        	<div class="cs-wrapp-clone cs-shortcode-wrapp">
              <ul class="form-elements  ">
                <li class="to-label">
                  <label><?php _e('Background View','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
                    <div class="select-style">
                      <select name="cs_section_background_option[]" class="dropdown" onchange="javascript:cs_section_background_settings_toggle(this.value,'<?php echo absint($randomno);?>')">
                        <option <?php if($cs_section_background_option=='no-image') echo "selected";?> value="no-image"><?php _e('None','dir');?></option>
                        <option <?php if($cs_section_background_option=='section-custom-background-image') echo "selected";?> value="section-custom-background-image"><?php _e('Background Image','dir');?></option>
                        <option <?php if($cs_section_background_option=='section-custom-slider') echo "selected";?> value="section-custom-slider"><?php _e('Custom Slider','dir');?></option>
                        <option  <?php if($cs_section_background_option=='section_background_video')echo "selected";?> value="section_background_video" > <?php _e('Video','dir');?></option>
                      </select>
                    </div>
                  </div>
                </li>
          ...
          <div class="meta-body noborder section-custom-background-image-<?php echo esc_attr($randomno);?>" style=" <?php if($cs_section_background_option == "section-custom-background-image"){echo "display:block";}else echo "display:none";?>" >
                ...
                <ul class="form-elements noborder">
                  <li class="to-label">
                    <label><?php _e('Background Image Position','dir');?></label>
                  </li>
                  <li class="to-field">
                    <div class="input-sec">
                      <div class="select-style">
                        <select name="cs_section_bg_image_position[]" class="select_dropdown">
                          ...
                          <option value="left" <?php if ($cs_section_bg_image_position=='light')echo "selected";?>><?php _e('Left','dir');?></option>
                          <option value="right" <?php if ($cs_section_bg_image_position=='right')echo "selected";?>><?php _e('Right','dir');?></option>
                          <option value="center" <?php if ($cs_section_bg_image_position=='center')echo "selected";?>><?php _e('Center','dir');?></option>
                        </select>
                      </div>
                    </div>
                  </li>
                    ...
                    <div class="input-sec">
                      <div class="select-style">
                        <select name="cs_section_bg_image_repeat[]" class="select_dropdown">
                          <option value="repeat" <?php if ($cs_section_bg_image_repeat=='repeat')echo "selected";?>><?php _e('Repeat','dir');?></option>
                          <option value="no-repeat" <?php if ($cs_section_bg_image_repeat=='no-repeat')echo "selected";?>><?php _e('No Repeat','dir');?></option>
                        </select>
                      </div>
                    </div>
                  </li>
          ...
          <div class="meta-body noborder section-custom-slider-<?php echo esc_attr($randomno);?>" style=" <?php if($cs_section_background_option == "section-custom-slider"){echo "display:block";}else echo "display:none";?>" >
                <ul class="form-elements noborder">
                  <li class="to-label">
                    <label><?php _e('Custom Slider','dir');?></label>
                  </li>
                  <li class="to-field">
                    <div class="input-sec">
          ...
          <div class="meta-body noborder section-background-video-<?php echo esc_attr($randomno);?>" style=" <?php if($cs_section_background_option == "section_background_video"){echo "display:block";}else echo "display:none";?>">
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Video Url','dir');?></label>
                  </li>
                  <li class="to-field">
                    <div class="input-sec">
                    ...
                    <div class="left-info">
                      <p><?php _e('Please enter Vimeo/Youtube Video URL','dir');?></p>
                    </div>
                  </li>
                </ul>
                <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('Enable Mute','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
                    <div class="select-style">
                      <select name="cs_section_video_mute[]" class="select_dropdown">
                        <option value="yes" <?php if ($cs_section_video_mute=='yes')echo "selected";?>><?php _e('Yes','dir');?></option>
                        <option value="no" <?php if ($cs_section_video_mute=='no')echo "selected";?>><?php _e('No','dir');?></option>
                      </select>
                    </div>
                  </div>
                </li>
              ...
              <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('Video Auto Play','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
                    <div class="select-style">
                      <select name="cs_section_video_autoplay[]" class="select_dropdown">
                        <option value="yes" <?php if ($cs_section_video_autoplay=='yes')echo "selected";?>><?php _e('Yes','dir');?>Yes</option>
                        <option value="no" <?php if ($cs_section_video_autoplay=='no')echo "selected";?>><?php _e('No','dir');?></option>
                      </select>
                    </div>
                  </div>
                </li>
              ...
              <ul class="form-elements noborder">
                <li class="to-label">
                  <label><?php _e('Enable Parallax','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
                    <div class="select-style">
                      <select name="cs_section_parallax[]" class="select_dropdown">
                        <option value="no" <?php if ($cs_section_parallax=='no')echo "selected";?>><?php _e('No','dir');?></option>
                        <option value="yes" <?php if ($cs_section_parallax=='yes')echo "selected";?>><?php _e('Yes','dir');?></option>
                      </select>
                    </div>
                  </div>
                </li>
              ...
              <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('Select View','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
                    <div class="select-style">
                      <select name="cs_section_view[]" class="select_dropdown">
                        <option value="container" <?php if ($cs_section_view=='container')echo "selected";?>><?php _e('Box','dir');?></option>
                        <option value="wide" <?php if ($cs_section_view=='wide')echo "selected";?>><?php _e('Wide','dir');?></option>
                      </select>
                    </div>
                  </div>
                </li>
              ...
              <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('Padding Top','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
                    ...
                    <p><?php _e('Set the Padding top (In px)','dir');?></p>
                  </div>
                </li>
              </ul>
              <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('Padding Bottom','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
                    ...
                    <p><?php _e('Set the Padding Bottom (In px)','dir');?></p>
                  </div>
                </li>
              </ul>
              <ul class="form-elements">
                ...
                <li class="to-field">
                  <div class="input-sec">
                    ...
                    <p><?php _e('Set the Border Bottom (In px)','dir');?></p>
                  </div>
                </li>
              </ul>
              <ul class="form-elements">
                ...
                <li class="to-field">
                  <div class="input-sec">
                    ...
                    <p><?php _e('Set the Margin Bottom (In px)','dir');?></p>
                  </div>
                </li>
              </ul>
              <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('Border Top','dir');?></label>
                </li>
                <li class="to-field">
                  <div class="input-sec">
                    ...
                    <p><?php _e('Set the Border top (In px)','dir');?></p>
                  </div>
                </li>
              </ul>
              <ul class="form-elements">
              ...
              <div class="form-elements elementhiddenn">
                    <ul class="noborder">
                      <li class="to-label">
                        <label><?php _e('Select Layout','dir');?></label>
                      </li>
                      <li class="to-field">
                      ...
                      <li class="to-label">
                        <label><?php _e('Select Left Sidebar','dir');?></label>
                      </li>
                      <li class="to-field">
                        ...
                        <p> <?php _e('Add New Sidebar','dir');?> <a href="<?php echo admin_url();?>themes.php?page=cs_theme_options#tab-manage-sidebars-show" target="_blank"><?php _e('Click Here','dir');?></a></p>
                      </li>
                </ul>
                	<ul class="meta-body" style=" <?php if($cs_layout == "right"){echo "display:block";}else echo "display:none";?>" id="<?php echo esc_attr($randomno);?>_sidebar_right" >
                      <li class="to-label">
                        <label><?php _e('Select Right Sidebar','dir');?></label>
                      </li>
                      <li class="to-field">
                        ...
                        <p>> <?php _e('Add New Sidebar','dir');?><a href="<?php echo esc_url(admin_url('themes.php?page=cs_theme_options#tab-manage-sidebars-show'));?>" target="_blank"><?php _e('Click Here','dir');?></a></p>
                      </li>
                </ul>
              </div>
              <ul class="form-elements noborder">
...
if ( ! function_exists( 'cs_pb_event' ) ) {
    ...
    <div id="<?php echo esc_attr($name.$cs_counter);?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> 
			<?php echo esc_attr($shortcode_view);?>" item="blog" data="<?php echo cs_element_size_data_array_index($event_element_size)?>" >
             ...
             <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter);?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter);?>" data-shortcode-template="[cs_event {{attributes}}]" style="display: none;">
                    <div class="cs-heading-area">
                      <h5><?php _e('Edit Event Options','dir');?></h5>
                    ...
                    <div class="cs-pbwp-content">
                          <ul class="form-elements noborder">
                                <li class="to-label">
                                  <label><?php _e('Event Title','dir');?></label>
                                </li>
                                <li class="to-field">
                                  <div class="input-sec">
                                  ...
                                  <div class="left-info">
                                    <p><?php _e('Event Page Title','dir');?></p>
                                  </div>
                                </li>
                          </ul>
                          <ul class="form-elements noborder">
                                <li class="to-label">
                                  <label><?php _e('Event Types','dir');?></label>
                                </li>
                                <li class="to-field">
                                  <div class="input-sec">
                                    <div class="select-style">
                                      <select name="cs_event_type[]" class="dropdown">
                                        <option <?php if($cs_event_type_db=="All Events")echo "selected";?>><?php _e('All Events','dir');?></option>
                                        <option <?php if($cs_event_type_db=="Upcoming Events")echo "selected";?>><?php _e('Upcoming Events','dir');?></option>
                                        <option <?php if($cs_event_type_db=="Past Events")echo "selected";?>><?php _e('Past Events','dir');?></option>
                                      </select>
                                    </div>
                                  </div>
                                  <div class="left-info">
                                    <p><?php _e('Select event type','dir');?></p>
                                  </div>
                                </li>
                          </ul>
                          <ul class="form-elements noborder">
                                  ...
                                  <div class="input-sec">
                                    <div class="select-style">
                                      <select name="cs_event_category[]" class="dropdown">
                                        <option value="0"><?php _e('-- All Categories Posts --','dir');?></option>
                                        <?php cs_show_all_cats('', '', $cs_event_category_db, "events-categories");?>
                                      </select>
                                    </div>
                                  </div>
                                </li>
                                  ...
                                  <div class="input-sec">
                                    <div class="select-style">
                                      <select name="cs_event_view[]" class="dropdown">
                                        <option <?php if($cs_event_view_db=="event-listing")echo "selected";?> value="event-listing"><?php _e('Listing View','dir');?></option>
                                        <option <?php if($cs_event_view_db=="timeline-view")echo "selected";?> value="timeline-view"><?php _e('Timeline View','dir');?></option>
                                      </select>
                                    </div>
                                  </div>
                                </li>
                          ...
                          <ul class="form-elements noborder">
                                <li class="to-label">
                                  <label><?php _e('Show Time','dir');?></label>
                                </li>
                                <li class="to-field">
                                  <div class="input-sec">
                                    <div class="select-style">
                                      <select name="cs_event_time[]" class="dropdown">
                                        <option value="Yes" <?php if($cs_event_time_db=="Yes")echo "selected";?> ><?php _e('Yes','dir');?></option>
                                        <option value="No" <?php if($cs_event_time_db=="No")echo "selected";?> ><?php _e('No','dir');?></option>
                                      </select>
                                    </div>
                                  </div>
                                </li>
                                  ...
                                  <div class="input-sec">
                                    <div class="select-style">
                                      <select name="cs_event_pagination[]" class="dropdown" >
                                        <option <?php if($cs_event_pagination_db=="Show Pagination")echo "selected";?> ><?php _e('Show Pagination','dir');?></option>
                                        <option <?php if($cs_event_pagination_db=="Single Page")echo "selected";?> ><?php _e('Single Page','dir');?></option>
                                      </select>
                                    </div>
                                  </div>
                                  <div class="left-info">
                                    <p><?php _e('Show navigation only at List View','dir');?></p>
                                  </div>
                                </li>
                          </ul>
                          <ul class="form-elements noborder">
                                <li class="to-label">
                                  <label><?php _e('No. of Events Per Page','dir');?></label>
                                </li>
                                <li class="to-field">
                                  <div class="input-sec">
                      ...
                      <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){?>
                          <ul class="form-elements">
                            <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo esc_js(str_replace('cs_pb_','',$name));?>','<?php echo esc_js($name.$cs_counter);?>','<?php echo esc_js($filter_element);?>')" ><?php _e('Insert','dir');?></a> 
                            </li>
                          </ul>
...
<li class="ui-state-default" id="<?php echo esc_attr($cs_counter)?>">
  ...
  <div class="poped-up" id="edit_<?php echo esc_attr($cs_counter)?>">
    ...
    <div class="cs-pbwp-content">
          <ul class="form-elements">
            <li class="to-label">
              <label><?php _e('Image Title','dir');?></label>
            </li>
            <li class="to-field">
          ...
          <ul class="form-elements">
            <li class="to-label">
              <label><?php _e('Image Description','dir');?></label>
            </li>
            <li class="to-field">
          ...
          <ul class="form-elements">
            <li class="to-label">
              <label><?php _e('Link Target','dir');?></label>
            </li>
            <li class="to-field">
              ...
              <p><?php _e('Please select image target','dir');?></p>
            </li>
          </ul>
          <ul class="form-elements">
            <li class="to-label"></li>
...
<li class="ui-state-default" id="<?php echo esc_attr($cs_counter);?>">
  <div class="thumb-secs">
    ...
    <img src="<?php echo esc_url($image_path[0]);?>" alt="">
        <div class="gal-edit-opts"> 
          <a href="javascript:galedit(<?php echo esc_js($cs_counter)?>)" class="edit"></a> <a href="javascript:del_this('post_thumb_slider',<?php echo esc_js($cs_counter);?>)" class="delete"></a>
         </div>
  </div>
 	 <div class="poped-up" id="edit_<?php echo esc_attr($cs_counter);?>">
        <div class="cs-heading-area">
        ...
        <div class="cs-pbwp-content">
              ...
              <ul class="form-elements">
                    <li class="to-label">
                      <label><?php _e('Use Image As','dir');?></label>
                    </li>
                    <li class="to-field">
                      <select name="<?php echo esc_attr($clone_field_name);?>use_image_as[]" class="select_dropdown" onchange="cs_toggle_gal(this.value, <?php echo esc_js($cs_counter)?>)">
                        <option <?php if($cs_node->use_image_as=="0")echo "selected";?> value="0"><?php _e('LightBox to current thumbnail','dir');?></option>
                        <option <?php if($cs_node->use_image_as=="1")echo "selected";?> value="1"><?php _e('LightBox to Video','dir');?></option>
                        <option <?php if($cs_node->use_image_as=="2")echo "selected";?> value="2"><?php _e('Link URL','dir');?></option>
                      </select>
                      <p><?php _e('Please select Image link where it will go','dir');?></p>
                    </li>
              </ul>
              <ul class="form-elements" id="video_code<?php echo esc_attr($cs_counter);?>" <?php if($cs_node->use_image_as=="0" or $cs_node->use_image_as=="" or $cs_node->use_image_as=="2")echo 'style="display:none"';?> >
                    ...
                    <li class="to-field">
                      ...
                      <p><?php _e('Enter Specific Video URL Youtube or Vimeo','dir');?></p>
                    </li>
              </ul>
              <ul class="form-elements" id="<?php echo esc_attr($clone_field_name);?>link_url<?php echo esc_attr($cs_counter)?>" <?php if($cs_node->use_image_as=="0" or $cs_node->use_image_as=="" or $cs_node->use_image_as=="1")echo 'style="display:none"';?> >
                    <li class="to-label">
                      <label><?php _e('Link URL','dir');?></label>
                    </li>
                    <li class="to-field">
                      ...
                      <p><?php _e('Enter Specific Link URL','dir');?></p>
                    </li>
              </ul>
              <ul class="form-elements">
                    <li class="to-label"></li>
...
<tr id="edit_track<?php echo esc_attr($counter_social);?>">
  ...
  <td class="centr" style="width:20%;"><a href="javascript:openpopedup('edit_track_form<?php echo esc_js($counter_social);?>')" class="actions edit">&nbsp;</a> <a onclick="javascript:return confirm('Are you sure! You want to delete this social icon')" href="javascript:cs_div_remove('edit_track<?php echo esc_attr($counter_social);?>')" class="actions delete">&nbsp;</a>
    <div class="poped-up" id="edit_track_form<?php echo esc_attr($counter_social);?>">
          ...
          <ul class="form-elements">
                <li class="to-label">
                  <label><?php _e('icon/image URL','dir');?></label>
                </li>
                <li class="to-field">
                  ...
                  <p><?php _e('Put Fontawsome icon/image url. You can get fontawsome icons from ','dir');?><a href="<?php _e('http://fortawesome.github.io/Font-Awesome/icons/','dir')?>"><?php _e('here','dir');?></a></p>
                </li>
          </ul>
          <ul class="form-elements">
                <li class="to-label">
...
if ( ! function_exists( 'cs_add_faq_to_list' ) ) {
    ...
    <tr class="parentdelete" id="edit_track<?php echo esc_attr($counter_faq)?>">
      ...
      <td style="width:0"><div  id="edit_track_form<?php echo esc_attr($counter_faq);?>" style="display: none;" class="table-form-elem">
          <div class="cs-heading-area">
            <h5 style="text-align: left;"><?php _e('FAQ Settings','dir');?></h5>
          ...
          <ul class="form-elements">
            <li class="to-label">
              <label><?php _e('FAQ Description','dir');?></label>
            </li>
            <li class="to-field">
...
if ( ! function_exists( 'cs_add_social_icon' ) ) {
    function cs_add_social_icon(){
        ...
        echo '<tr id="del_' .str_replace(' ','-',$_POST['social_net_tooltip']).'">
            ...
            <td>';if(isset($icon_awesome) and $icon_awesome<>''){;echo '<i style="color:'.$_POST['social_font_awesome_color'].'!important;" class="fa '.$_POST['social_net_awesome'].' icon-2x"></i>';}else{;echo '<img width="50" src="' .$_POST['social_net_icon_path']. '">';}echo '</td> 
                  ...
                  <li class="to-label">
                    ...
                    <li style="padding: 10px 0px 20px;" class="full">
                       <ul id="cs_infobox_networks'.$counter_icon.'">
                          <li class="to-label">
                            <label>'.__('Fontawsome Icon','dir').'</label>
                          </li>
                    ...
                    <li class="to-label">
                      <label>'.__('Font Awesome Color','dir').'<span></span></label>
                    </li>
                    <li class="to-field">
                      <div class="input-sec">
    ...
    function cs_add_banner_fields(){
        ...
        echo '<tr id="del_' .cs_slugify_text($_POST['banner_field']).'">
                ...
                if($_POST['banner_field_type'] == 'image'){
                    echo '<td><img src="' . $_POST['banner_field_image'] . '" alt="" width="100" /></td>';
                }
                else{
                ...
                <td colspan="3">
                  <ul class="form-elements">
                    ...
                    <li class="to-field">
                      ...
                      <p>'.__('Please enter Banner Title','dir').'</p>
                    </li>
                    <li class="to-label">
                      <label>'.__('Banner Style','dir').'</label>
                    </li>
                    <li class="to-field select-style">
                      ...
                      <p>'.__('Please enter Banner Banner Style','dir').'</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>'.__('Email','dir').'Banner Type</label>
                    </li>
                    <li class="to-field select-style">
                    ...
                    <li class="to-field" id="cs_banner_image_value_'.$cs_rand_id.'" style="display:'.$cs_baner_image_display.';">
                      ...
                      <p>'.__('Please enter Banner Image','dir').'</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>'.__('Url','dir').'</label>
                    ...
                    <li class="to-field">
                      ...
                      <p>'.__('Please enter Banner URL','dir').'</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>'.__('Target','dir').'</label>
                    </li>
                    <li class="to-field select-style">
                      <select name="banner_field_url_target[]">
                        <option '. $cs_self_target_selected .' value="_self">'.__('Email','dir').'Self</option>
                        <option '. $cs_blank_target_selected .' value="_blank">'.__('Email','dir').'Blank</option>
                      </select>
                      <p>'.__('Please select Banner Link Target','dir').'</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label" id="cs_banner_code_field_'.$cs_rand_id.'" style="display:'.$cs_baner_code_display.';">
                      <label>'.__('Adsense Code','dir').'</label>
                    </li>
                    <li class="to-field" id="cs_banner_code_value_'.$cs_rand_id.'" style="display:'.$cs_baner_code_display.';">
                      ...
                      <p>'.__('Please enter Banner Adsense Code','dir').'</p>
                    </li>
                    <li class="full">&nbsp;</li>
