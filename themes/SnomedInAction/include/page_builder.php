            ...
            <div class="tabs vertical">
                <nav class="admin-navigtion">
                   <ul id="myTab" class="nav nav-tabs">
                     <li class="active"><a href="#tab-general-settings" data-toggle="tab"><i class="icon-gear"></i><?php _e('General Settings','dir');?> </a></li>
                     <li><a href="#tab-slideshow" data-toggle="tab"><i class="icon-forward2"></i> <?php _e('Subheader','dir');?></a></li>
                     <?php if($cs_builtin_seo_fields == 'on'){?>
                     <li><a href="#tab-seo-advance-settings" data-toggle="tab"><i class="icon-globe4"></i><?php _e('Seo Options','dir');?> </a></li>
                     <?php }?>
                ...
                if ( isset($_POST['builder_active']) ) {
                    ...
                    $sxe = cs_page_options_save_xml($sxe);
                                        ...
                                        // Save register page element 
                                            ...
                                            if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
                                                ...
                                                if(isset($_POST['register_text'][$cs_counter_register]) && $_POST['register_text'][$cs_counter_register] != ''){
                                                    $shortcode .=     htmlspecialchars($_POST['register_text'][$cs_counter_register], ENT_QUOTES);
                                                }
                                                $shortcode .=     '[/cs_register]';
                            ...
                            // Media Elements Shortcode
                                        ...
                                        // Directory Search
                                        else if ( $_POST['cs_orderby'][$cs_counter] == "directory_search" ) {
                                            $shortcode = '';
                                                    $directory_search = $column->addChild('directory_search');
                                                    $directory_search->addChild('page_element_size', htmlspecialchars($_POST['directory_search_element_size'][$cs_global_counter_directory_search]) );
                                                    $directory_search->addChild('directory_search_element_size', htmlspecialchars($_POST['directory_search_element_size'][$cs_global_counter_directory_search]) );
                                                    if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
                                                        $shortcode_str = stripslashes ($_POST['shortcode']['directory_search'][$cs_shortcode_counter_directory_search]);
                                                        $cs_shortcode_counter_directory_search++;
                                                        $directory_search->addChild('cs_shortcode', htmlspecialchars($shortcode_str) );
                                                    } else {
                                                        $shortcode = '[cs_directory_search ';
                                                        if(isset($_POST['directory_search_title'][$cs_counter_directory_search]) && $_POST['directory_search_title'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='directory_search_title="'.htmlspecialchars($_POST['directory_search_title'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
                                                        
                                                        if(isset($_POST['cs_directory_map_style'][$cs_counter_directory_search]) && $_POST['cs_directory_map_style'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='cs_directory_map_style="'.htmlspecialchars($_POST['cs_directory_map_style'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
                                                        
                                                        if(isset($_POST['cs_directory_search_filter'][$cs_counter_directory_search]) && $_POST['cs_directory_search_filter'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='cs_directory_search_filter="'.htmlspecialchars($_POST['cs_directory_search_filter'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
                                                        
                                                        if(isset($_POST['cs_directory_map'][$cs_counter_directory_search]) && $_POST['cs_directory_map'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='cs_directory_map="'.htmlspecialchars($_POST['cs_directory_map'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
														if(isset($_POST['cs_directory_map_responsive'][$cs_counter_directory_search]) && $_POST['cs_directory_map_responsive'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='cs_directory_map_responsive="'.htmlspecialchars($_POST['cs_directory_map_responsive'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
                                                        
														if(isset($_POST['cs_directory_search_result_page'][$cs_counter_directory_search]) && $_POST['cs_directory_search_result_page'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='cs_directory_search_result_page="'.htmlspecialchars($_POST['cs_directory_search_result_page'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
														
                                                        if(isset($_POST['directory_search_results_per_page'][$cs_counter_directory_search]) && $_POST['directory_search_results_per_page'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='directory_search_results_per_page="'.htmlspecialchars($_POST['directory_search_results_per_page'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
                                                        
                                                        if(isset($_POST['cs_search_views'][$cs_counter_directory_search]) && $_POST['cs_search_views'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='cs_search_views="'.htmlspecialchars($_POST['cs_search_views'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
														if(isset($_POST['cs_field_lables'][$cs_counter_directory_search]) && $_POST['cs_field_lables'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='cs_field_lables="'.htmlspecialchars($_POST['cs_field_lables'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
														if(isset($_POST['directory_search_latitude'][$cs_counter_directory_search]) && $_POST['directory_search_latitude'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='directory_search_latitude="'.htmlspecialchars($_POST['directory_search_latitude'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
														if(isset($_POST['directory_search_longitude'][$cs_counter_directory_search]) && $_POST['directory_search_longitude'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='directory_search_longitude="'.htmlspecialchars($_POST['directory_search_longitude'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }
														if(isset($_POST['cs_directory_search_class'][$cs_counter_directory_search]) && $_POST['cs_directory_search_class'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='cs_directory_search_class="'.htmlspecialchars($_POST['cs_directory_search_class'][$cs_counter_directory_search], ENT_QUOTES).'" ';
                                                        }if(isset($_POST['cs_directory_search_animation'][$cs_counter_directory_search]) && $_POST['cs_directory_search_animation'][$cs_counter_directory_search] != ''){
                                                            $shortcode .='cs_directory_search_animation="'.htmlspecialchars($_POST['cs_directory_search_animation'][$cs_counter_directory_search]).'" ';
                                                        }
                                                        $shortcode .=']';
                                                        $directory_search->addChild('cs_shortcode', $shortcode );
                                                        $cs_counter_directory_search++;
                                                    }
                                                $cs_global_counter_directory_search++;
                                        }
										...
										// Multiple services
                                                    ...
                                                    if(isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode'){
                                                        ...
                                                        if(isset($_POST['multiple_services_num'][$cs_counter_multiple_services]) && $_POST['multiple_services_num'][$cs_counter_multiple_services]>0){
                                                            for ( $i = 1; $i <= $_POST['multiple_services_num'][$cs_counter_multiple_services]; $i++ ){
                                                                ...
                                                                $shortcode_item .= '[multiple_services_item ';
                                                    ...
                                                    if(isset($_POST['cs_multiple_service_section_title'][$cs_counter_multiple_services])  && $_POST['cs_multiple_service_section_title'][$cs_counter_multiple_services] != ''){
                                                        $section_title ='cs_multiple_service_section_title="'.htmlspecialchars($_POST['cs_multiple_service_section_title'][$cs_counter_multiple_services], ENT_QUOTES).'" ';
                                                    }
                                                    $shortcode = '[cs_multiple_services ';
                                                    ...
                                                    $shortcode .= ']'.$shortcode_item.'[/cs_multiple_services]';        
