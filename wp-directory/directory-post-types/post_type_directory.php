		   ...
		   */
			public function cs_directory_general_settings($directory_post_id=''){
				global $post, $cs_xmlObject,$cs_theme_options;
					...
					<?php //var_dump(esc_attr($dir_how)); ?>
                                        <span class="to-label" style="display: block; padding: 10px; font-size: 16px;"><label for="dir_objective">Objective</label></span>
                            <?php wp_editor(isset($dir_objective) ? ($dir_objective) : '', 'dir_objective', ['textarea_name' => 'dir_cusotm_field[dir_objective]', 'media_buttons' => false]); ?>
                                        
                                        <span class="to-label" style="display: block; padding: 10px; font-size: 16px;"><label for="dir_scope">Scope</label></span>
                            <?php wp_editor(isset($dir_scope) ? ($dir_scope) : '', 'dir_scope', ['textarea_name' => 'dir_cusotm_field[dir_scope]', 'media_buttons' => false]); ?>
                            ...
                            <?php wp_editor(isset($dir_how) ? ($dir_how) : '', 'dir_how', ['textarea_name' => 'dir_cusotm_field[dir_how]', 'media_buttons' => false]); ?>
                            ...
                            <?php wp_editor(isset($dir_why) ? ($dir_why) : '', 'dir_why', ['textarea_name' => 'dir_cusotm_field[dir_why]', 'media_buttons' => false]); ?>
